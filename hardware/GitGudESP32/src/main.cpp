...
// WiFi credentials
const char* ssid = "MonkataNet"; //TODO: Change fake credentials for the presentation
const char* password = "parolanasimozanet"; //TODO: Change fake credentials for the presentation
